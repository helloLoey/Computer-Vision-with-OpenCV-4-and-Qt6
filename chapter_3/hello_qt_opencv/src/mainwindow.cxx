...
MainWindow::MainWindow(QWidget *t_parent) :
    ...
    m_russian_translator(new QTranslator(this))
{
    setupUi();
    initializationOfConnection();
    initializationOfTranslators();
    loadSettings();
}
...
void MainWindow::initializationOfConnection()
{
    ...
    connect(ui->actionEnglish, &QAction::triggered, this, &MainWindow::actionEnglish_triggered);
    connect(ui->actionRussian, &QAction::triggered, this, &MainWindow::actionRussian_triggered);
}

bool MainWindow::initializationOfTranslators()
{
    return m_russian_translator->load(":/qm/ru.qm");
}
...
void MainWindow::actionRussian_triggered()
{
    qApp->installTranslator(m_russian_translator);
}

void MainWindow::actionEnglish_triggered()
{
    qApp->removeTranslator(m_russian_translator);
}
