...
private:
    Ui::PluginGui *ui;
    QList<cv::AgastFeatureDetector::DetectorType> m_agast_type_list;
    QList<cv::FastFeatureDetector::DetectorType> m_fast_type_list;
    QList<cv::AKAZE::DescriptorType> m_akaze_type_list;
    QList<cv::KAZE::DiffusivityType> m_kaze_type_list;
    QList<cv::DescriptorMatcher::MatcherType> m_matcher_type;
    cv::Mat secondImage;
